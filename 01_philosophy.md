...
- **비타협 항목 표** (진입점 / 스키마 / Prefs 등 - 변경 시 사용자 컨펌 필수 항목)
- 빌드/실행 커맨드 정형구
...
Phase 1~3 (week 1~3, 리스트-디테일 + 검색 + Room 저장 구현):
...
Phase O10 (크래시 보고, week 8):
  ...
  - CI Gate 추가: Room 스키마 버전 상수 회귀 검사 (누가 무심코 변경한 사고)
  - BRAIN.md 367줄 (11개 Prefs + 외부 인터페이스 §11 추가)
