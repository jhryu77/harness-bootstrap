...
- 분류: Android 리스트-디테일 앱 (MAIN+LAUNCHER 진입)
...
└── .agent/
    ...
    ├── context/
    │   ├── SAMPLEAPP_BRAIN.md             367줄 - 패키지/디렉토리 트리/클래스 책임/12개 SharedPreferences 키 인벤토리/외부 인터페이스
...
`WEBAPP_BRAIN.md` 예시:
```
§1 제품 요약: SampleApp Admin Webapp, com.sampleapp.admin
