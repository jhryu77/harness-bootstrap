...
sampleapp 차량용 런처 프로젝트의 현재 상태를 빠르게 파악한다.
...
echo
echo "=== 시스템 런처 인텐트 필터 ==="
grep -E "android.intent.category.HOME|DEFAULT|LAUNCHER" app/src/main/AndroidManifest.xml || echo "MISSING"
echo
echo "=== git 최근 5개 ==="
...
- split_ratio.left_percent (Float, 0.20~0.80)
- pane_slots.{left,right}_{pkg,cls} (String?)

### 시스템 런처 인텐트 필터
- HOME / DEFAULT / LAUNCHER : (점검 결과)
