...
사용법:
  python3 .agent/scripts/glm_mode.py setup <api-key> [--base-url URL] [--model MODEL_ID]
  python3 .agent/scripts/glm_mode.py status
  python3 .agent/scripts/glm_mode.py spawn [--name PANE_NAME]
  python3 .agent/scripts/glm_mode.py teardown
