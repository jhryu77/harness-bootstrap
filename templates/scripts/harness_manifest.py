...
사용법:
  python .agent/scripts/harness_manifest.py generate [--kit-version 1.3.0] [--date 2026-07-04T00:00:00]
  python .agent/scripts/harness_manifest.py check
  python .agent/scripts/harness_manifest.py merge-gitignore --from <킷_gitignore_파일>
...
def cmd_check(_args) -> int:
    ...
    if manifest is None:
        ...
        print("먼저 generate 를 실행하세요: python .agent/scripts/harness_manifest.py generate")
        return 1
